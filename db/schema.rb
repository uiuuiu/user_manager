...
ActiveRecord::Schema[7.1].define(version: 2024_02_03_162046) do
  ...
  create_table "team_roles", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "team_user_roles", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["team_user_id"], name: "index_team_user_roles_on_team_user_id"
  end
  ...
  create_table "users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["username"], name: "unique_not_null_username", unique: true
  end
  ...
  add_foreign_key "team_user_roles", "team_roles"
